...
namespace NetSockets
{
    ...
    public abstract class NetBaseClient<T>
    {
        ...
        /// </summary>
        public NetBaseClient(string nm)
        {
            IsConnected = false;
            name = nm;
        }
        ...
        protected void Disconnect(NetStoppedReason reason)
        {
            ...
            //stream.stop will call me again because this method is defined for its Stopped event
            //we prevent recurrent call by setting IsConnected to false
            stream.Stop();
            tcp.Close();
