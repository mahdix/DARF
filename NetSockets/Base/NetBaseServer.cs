...
namespace NetSockets
{
    ...
    public abstract class NetBaseServer<T>
    {
        ...
        /// </summary>
        public NetBaseServer(string nm)
        {
        ...
        private TcpClient tryAcceptClient()
        {
            IAsyncResult asyncReader = tcp.BeginAcceptTcpClient(null, null);
            ...
            if (completed)
            {
                return tcp.EndAcceptTcpClient(asyncReader);
            }

            tcp.EndAcceptTcpClient(asyncReader);
        ...
        protected void OnClientReceived(object sender, NetStreamReceivedEventArgs<T> e)
        {
            ...
            NetClientReceivedEventArgs<T> args = new NetClientReceivedEventArgs<T>(e.Data, e.Guid);
            if (OnReceived != null)
        ...
        protected void OnClientStopped(object sender, NetStreamStoppedEventArgs e)
        {
            ...
            Guid clientId = e.Guid;
            NetBaseStream<T> clientStream = streams[clientId];
